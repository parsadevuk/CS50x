...
class WelcomeScreen extends ConsumerWidget {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // App logo — responsive to screen height
                  Builder(builder: (context) {
                    final logoSize = MediaQuery.of(context).size.height * 0.32;
                    return Image.asset(
  ...
  PageRouteBuilder _slide(Widget page) => PageRouteBuilder(  // ignore: prefer_function_declarations_over_variables
